...
class PostgreSqlConnectorTest {
  ...
  @Test
  void connectorIdShouldBePostgresql() {
    assertThat(connector.connectorId()).isEqualTo("postgresql");
  }

  @Test
  void shouldSupportPostgresqlType() {
    assertThat(connector.supports(profile(DatabaseType.POSTGRESQL))).isTrue();
  }
