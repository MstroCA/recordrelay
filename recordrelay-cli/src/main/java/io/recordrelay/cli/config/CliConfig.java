...
public class CliConfig {
  ...
  public Map<String, EnvironmentEntry> getEnvironments() {
    return environments;
  }

  public void setEnvironments(Map<String, EnvironmentEntry> environments) {
    this.environments = environments;
  }

  public Map<String, ConnectionEntry> getConnections() {
    return connections;
  }
